...
*🟨 INFO:* Khursheed Bot has killed all active event listeners for this chat node. No reactions, no status, no logs!
`;
...
*🟨 INFO:* Firewall bypass authorized. Khursheed Galkala Bot is now listening to this gateway node again.
`;
