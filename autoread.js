/**
 * 👑 KHURSHEED GALKALA-BOT - AUTO-READ ENGINE
            ...
            if (action === 'on' || action === 'enable') {
                ...
                await sock.sendMessage(chatId, {
                    ...
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            newsletterJid: '120363321946059637@newsletter',
                            newsletterName: '𝙆𝙃𝙐𝙍𝙎𝙃𝙀𝙀𝘿 𝗨𝗟𝗧𝗥𝗔-𝗕𝗢𝗧',
                            serverMessageId: -1
                        }
                    }
                });
...
function isBotMentionedInMessage(message, botNumber) {
    ...
    if (textContent) {
        ...
        const botNames = [global.botname?.toLowerCase(), 'bot', 'khursheed-bot', 'galkala-cyber-tech'];
